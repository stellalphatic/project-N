        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDepartmentHead = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsInterUniversityRep = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsSocietyRep = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PerkAssignments",
                columns: table => new
                {
                    PerkAssignmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Perks = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerkAssignments", x => x.PerkAssignmentId);
                    table.ForeignKey(
                        name: "FK_PerkAssignments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SocietyPostId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Title = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Content = table.Column<string>(type: "longtext", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocietyPosts", x => x.SocietyPostId);
                    table.ForeignKey(
                        name: "FK_SocietyPosts_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "SocietyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SocietyRepresentativeApplications",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocietyRepresentativeApplications", x => x.ApplicationId);
                    table.ForeignKey(
                        name: "FK_SocietyRepresentativeApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SocietyRepresentativeApplications_Societies_SocietyId",
                        column: x => x.SocietyId,
                        principalTable: "Societies",
                        principalColumn: "SocietyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventEventCategory_EventCategories_EventCategoriesEventCateg~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoticeId = table.Column<int>(type: "int", nullable: true),
                    EventId = table.Column<int>(type: "int", nullable: true),
                    EventCategory = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistItems_Notices_NoticeId",
                        column: x => x.NoticeId,
                        principalTable: "Notices",
                        principalColumn: "NoticeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerkAssignments_UserId",
                table: "PerkAssignments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocietyPosts_SocietyId",
                table: "SocietyPosts",
                column: "SocietyId");

            migrationBuilder.CreateIndex(
                name: "IX_SocietyRepresentativeApplications_SocietyId",
                table: "SocietyRepresentativeApplications",
                column: "SocietyId");

            migrationBuilder.CreateIndex(
                name: "IX_SocietyRepresentativeApplications_UserId",
                table: "SocietyRepresentativeApplications",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_NoticeId",
                table: "WishlistItems",
                column: "NoticeId");
